...
export default function VideoWorkspace() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-slate-50 flex flex-col p-4 md:p-6 lg:p-8 w-full mx-auto animate-in fade-in duration-500 relative">
          ...
          <div className="flex-1 flex flex-col gap-6 min-w-0">
            ...
            <div className="bg-white rounded-[1.5rem] border border-slate-200 p-4 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex-1 min-w-50 text-left sm:text-right w-full sm:w-auto">
                {videoTitle ? <h2 className="text-slate-800 font-bold truncate text-lg" title={videoTitle}>{videoTitle}</h2> : <span className="text-slate-400 text-sm italic">Video Workspace</span>}
              </div>
            </div>
